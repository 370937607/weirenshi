...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "niit.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "niit.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "niit.mail.routing.key";
}